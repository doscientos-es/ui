...
export const Overlays: Story = {
  render: () => <div className="flex items-center gap-3"><TooltipTrigger delay={0}><Button variant="outline">Información</Button><Tooltip>Se muestra al enfocar o pasar el cursor.</Tooltip></TooltipTrigger><PopoverTrigger><Button>Opciones</Button><Popover><div className="p-2 text-sm">Contenido contextual accesible.</div></Popover></PopoverTrigger></div>,
};

export const DividerAndShortcut: Story = {
  render: () => <div className="w-72 space-y-3"><p className="text-sm">Guarda los cambios</p><Separator /><p className="flex items-center justify-between text-sm">Abrir búsqueda <KbdGroup><Kbd>⌘</Kbd><Kbd>K</Kbd></KbdGroup></p></div>,
};
