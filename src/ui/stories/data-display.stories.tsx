  ...
  render: () => (
    <Card className="w-96">
      <CardHeader>
        ...
        <CardDescription>Actualizado hace 2 minutos</CardDescription>
      </CardHeader>
      <CardContent>
        <Badge variant="success">Al día</Badge>
      </CardContent>
      <CardFooter className="text-muted-foreground text-sm">Facturación mensual</CardFooter>
    </Card>
  ),
}
  ...
  render: () => (
    <div className="flex w-96 flex-col gap-5">
      <EmptyState>
        ...
        <EmptyStateDescription>Crea la primera factura para verla aquí.</EmptyStateDescription>
      </EmptyState>
