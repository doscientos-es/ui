...
export type CheckboxProps = Omit<AriaCheckboxFieldProps, 'className' | 'children'> & {
  className?: string
  children?: AriaCheckboxButtonProps['children']
}

/** Checkbox that supports controlled and uncontrolled selection. */
export function Checkbox({ className, children, ...props }: CheckboxProps) {
  return (
    <AriaCheckboxField data-slot="checkbox" {...props}>
      <AriaCheckboxButton
        className={cn(
