...
describe("AlertDialog", () => {
  it("exposes alertdialog semantics and closes through the cancel action", () => {
    ...
    render(<AlertDialog open onOpenChange={onOpenChange}><AlertDialogContent><AlertDialogTitle>Eliminar cliente</AlertDialogTitle><AlertDialogCancel /></AlertDialogContent></AlertDialog>);
