...
describe("Accordion", () => {
  it("uses semantic appearance tokens", () => {
    ...
    expect(container.querySelector('[data-slot="accordion"]')?.classList).toContain("text-foreground");
    expect(container.querySelector('[data-slot="accordion-item"]')?.classList).toContain("border-border");
