...
export const WithLabel: Story = {
  render: (args) => <div className="grid w-80 gap-2"><Label htmlFor="input-company">Empresa</Label><Input {...args} id="input-company" aria-label={undefined} placeholder="Doscientos" /></div>,
};
